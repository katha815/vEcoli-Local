#!/bin/bash
#SBATCH --job-name=gene_ko_462_operon_on_basal
#SBATCH --partition=compute
#SBATCH --time=14-00:00:00
#SBATCH --chdir=/user/home/il22158
#SBATCH --account=emat024603
#SBATCH --output=/user/home/il22158/work/slurm_logs/gene_ko_462_operon_on_basal.%j.out
#SBATCH --mem=200G
...
echo "Re-run for 462 gene knockout for 10 generations with operon on basal conditions..."
python runscripts/workflow.py --config configs/N_gene_knockout_462_operon_on_basal.json
