#!/bin/bash
#SBATCH --job-name=colony_3_gen
#SBATCH --partition=compute
#SBATCH --time=3-00:00:00
#SBATCH --chdir=/user/home/il22158
#SBATCH --account=emat024603
#SBATCH --output=slurm_logs/colony_3_gen.%j.out
#SBATCH --mem=100G
...
echo "Running colony simulation from 2nd to 3rd generation..."
python ecoli/experiments/ecoli_engine_process.py --config configs/colony_baseline_3_gen.json